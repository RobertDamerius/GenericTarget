#ifndef GT_DRIVER_UDP_SEND_H
#define GT_DRIVER_UDP_SEND_H
 ...
 */
extern void GT_DeleteDriverUDPSend(void);
 ...
 */
extern void GT_OutputDriverUDPSend(int32_t* result, uint16_t port, uint16_t* destination, uint8_t* bytes, uint32_t length);


#endif /* GT_DRIVER_UDP_SEND_H */
