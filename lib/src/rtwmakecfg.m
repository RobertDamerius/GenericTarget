...
%    MATLAB file generated on : 23-May-2023 22:20:29
...
info(5).SFunctionName = 'SFunctionGTDriverTargetExecutionTime';
info(5).SourceFiles = {'GT_DriverTargetExecutionTime.cpp', 'GT_SimulinkSupport.cpp'};
