#ifndef GT_DRIVER_TIMER_UTC_H
#define GT_DRIVER_TIMER_UTC_H
 ...
 */
extern void GT_CreateDriverTimerUTC(void);

/**
 *  @brief Delete the UTC timer driver.
 */
extern void GT_DeleteDriverTimerUTC(void);
 ...
 */
extern void GT_OutputDriverTimerUTC(int32_t* nanoseconds, int32_t* second, int32_t* minute, int32_t* hour, int32_t* mday, int32_t* mon, int32_t* year, int32_t* wday, int32_t* yday, int32_t* isdst);


#endif /* GT_DRIVER_TIMER_UTC_H */
