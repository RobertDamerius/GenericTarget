 ...
 *
 *         void GT_DriverDataRecorderScalarDoublesStep(uint32 p1, double u1, double u2[], uint32 p4)
 *
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverDataRecorderScalarDoublesInitialize(*p1, p2, *p3, *p4, *p5);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverDataRecorderScalarDoublesStep(*p1, *u1, u2, *p4);
}
