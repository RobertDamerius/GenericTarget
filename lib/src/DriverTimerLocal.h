#ifndef DRIVER_TIMER_LOCAL_H
#define DRIVER_TIMER_LOCAL_H
 ...
 */
extern void CreateDriverTimerLocal(void);

/**
 *  @brief Delete the local timer driver.
 */
extern void DeleteDriverTimerLocal(void);
 ...
 */
extern void OutputDriverTimerLocal(int32_t* nanoseconds, int32_t* second, int32_t* minute, int32_t* hour, int32_t* mday, int32_t* mon, int32_t* year, int32_t* wday, int32_t* yday, int32_t* isdst);


#endif /* DRIVER_TIMER_LOCAL_H */
