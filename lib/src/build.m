...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% Driver: Target Execution Time
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def = legacy_code('initialize');
def.SFunctionName = 'SFunctionGTDriverTargetExecutionTime';
def.StartFcnSpec  = 'void GT_DriverTargetExecutionTimeInitialize()';
def.TerminateFcnSpec = 'void GT_DriverTargetExecutionTimeTerminate()';
def.OutputFcnSpec = 'void GT_DriverTargetExecutionTimeStep(double y1[1])';
def.HeaderFiles   = {'GT_DriverTargetExecutionTime.hpp'};
def.SourceFiles   = {'GT_DriverTargetExecutionTime.cpp','GT_SimulinkSupport.cpp'};
def.IncPaths      = {''};
def.SrcPaths      = {''};
def.LibPaths      = {''};
def.HostLibFiles  = {hostLibFiles};
...
if(useSimulinkSupport)
    ...
    fprintf('\tInterface/Record Doubles To File      no\n');
    fprintf('\tInterface/Record Bus To File          no\n');
    fprintf('\tInterface/Multicast UDP Send          partially (*)\n');
    fprintf('\tInterface/Multicast UDP Receive       partially (*)\n');
    fprintf('\tTime/Target Execution Time            yes (**)\n');
