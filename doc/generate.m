...
layoutNavBar = [
    ...
    SimpleDoc.NavEntry(SimpleDoc.NavEntryType.link, 'Data Recorder Manager', 'datarecorder.html');
    SimpleDoc.NavEntry(SimpleDoc.NavEntryType.none);
    SimpleDoc.NavEntry(SimpleDoc.NavEntryType.link, 'Protocol File', 'textlog.html');
