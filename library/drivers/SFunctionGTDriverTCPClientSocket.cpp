/**
 * SFunctionGTDriverTCPClientSocket.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GT_DriverTCPClientSocketStep(int32 p1, uint8 p5, int32 p6, uint8 y1[p6], int32 y2[1], int32 y3[1], uint8 y4[1], uint8 u1[4], uint16 u2, uint8 p7, uint8 u3[], int32 u4)
 *
...
#define S_FUNCTION_NAME  SFunctionGTDriverTCPClientSocket
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    /* Check the parameter 8 (sample time) */
    if (EDIT_OK(S, 7)) {
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y1Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 5));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GT_DriverTCPClientSocketInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverTCPClientSocketStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverTCPClientSocketTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverTCPClientSocketInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverTCPClientSocketStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverTCPClientSocketTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverTCPClientSocketInitialize(*p1, p2, *p3, *p4);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverTCPClientSocketStep(*p1, *p5, *p6, y1, y2, y3, y4, u1, *u2, *p7, u3, *u4);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    GT_DriverTCPClientSocketTerminate(*p1);
}
