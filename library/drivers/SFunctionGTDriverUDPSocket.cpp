 ...
 *
 *         void GT_DriverUDPSocketStep(int32 p1, uint8 p11, int32 p12, uint8 y1[p12], uint8 y2[4], uint16 y3[1], int32 y4[1], int32 y5[1], uint8 u1[4], uint16 u2, uint8 u3[], int32 u4, uint8 u5[], uint32 u6)
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C++ source code generated on : 17-Sep-2026 09:21:58
 *
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverUDPSocketStep(*p1, *p11, *p12, y1, y2, y3, y4, y5, u1, *u2, u3, *u4, u5, *u6);
}
