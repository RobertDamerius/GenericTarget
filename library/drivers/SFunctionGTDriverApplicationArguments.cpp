/**
 * SFunctionGTDriverApplicationArguments.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GT_DriverApplicationArgumentsStep(uint8 y1[p1*p2], uint32 y2[p2], uint32 y3[1], uint32 p1, uint32 p2)
 *
...
#define S_FUNCTION_NAME  SFunctionGTDriverApplicationArguments
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y1Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0))*(int_T)mxGetScalar(ssGetSFcnParam(S, 1));
    ...
    {
        int_T y2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 1));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GT_DriverApplicationArgumentsInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverApplicationArgumentsStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverApplicationArgumentsTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverApplicationArgumentsInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverApplicationArgumentsStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverApplicationArgumentsTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverApplicationArgumentsInitialize();
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverApplicationArgumentsStep(y1, y2, y3, *p1, *p2);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    GT_DriverApplicationArgumentsTerminate();
}
