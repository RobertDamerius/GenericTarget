/**
 * SFunctionGTDriverDataRecorder.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GT_DriverDataRecorderStep(uint8 p1, uint8 p2[], uint32 p3, double u1, double u2[p6], uint32 p6, uint8 u3[p5], uint32 p5, uint8 p14)
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C++ source code generated on : 27-Jun-2026 14:16:01
 *
...
#define S_FUNCTION_NAME  SFunctionGTDriverDataRecorder
...
#define SAMPLE_TIME (ssGetSFcnParam(S, 14))
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    if (EDIT_OK(S, 5)) {
        ...
        /* Parameter 6 must be numeric */
        if (!mxIsNumeric(ssGetSFcnParam(S, 5))) {
            ssSetErrorStatus(S,"Parameter 6 must be numeric");
            return;
        } /* if */
    ...
    /* Check the parameter 15 (sample time) */
    if (EDIT_OK(S, 14)) {
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T u2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 5));
        if (u2Width!=DYNAMICALLY_SIZED && u2Width < 1) { ssSetErrorStatus(S, "Input 2: the current width is < 1"); return; }
    ...
    {
        int_T u3Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 4));
        if (u3Width!=DYNAMICALLY_SIZED && u3Width < 1) { ssSetErrorStatus(S, "Input 3: the current width is < 1"); return; }
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GT_DriverDataRecorderInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverDataRecorderStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverDataRecorderTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverDataRecorderInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverDataRecorderStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverDataRecorderTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 9, 9, "p10", ssGetDataTypeId(S, "uint32"));
    ...
    ssRegDlgParamAsRunTimeParam(S, 13, 13, "p14", ssGetDataTypeId(S, "uint8"));
}
#endif
...
static void mdlStart(SimStruct *S)
{
    ...
    uint32_T* p10 = (uint32_T*) ssGetRunTimeParamInfo(S, 9)->data;
    ...
    uint8_T* p14 = (uint8_T*) ssGetRunTimeParamInfo(S, 13)->data;


    /* Call the legacy code function */
    GT_DriverDataRecorderInitialize(*p1, p2, *p3, *p4, *p5, *p6, p7, *p8, p9, *p10, p11, *p12, *p13, *p14);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverDataRecorderStep(*p1, p2, *p3, *u1, u2, *p6, u3, *p5, *p14);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    GT_DriverDataRecorderTerminate(*p14);
}
