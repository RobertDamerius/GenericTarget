 ...
 *
 *         void GT_DriverDataRecorderBusStep(uint32 p1, double u1, uint8 u2[p3], uint32 p3)
 *
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T u2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 2));
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverDataRecorderBusInitialize(*p1, *p2, *p3, p4, *p5, p6, *p7, p8, *p9);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverDataRecorderBusStep(*p1, *u1, u2, *p3);
}
