/**
 * SFunctionGTDriverDataRecorderBus.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GT_DriverDataRecorderBusStep(uint8 p1[], uint32 p2, double u1, uint8 u2[p4], uint32 p4)
 *
 *    Simulink version           : 10.6 (R2022b) 13-May-2022
 *    C++ source code generated on : 20-Jul-2023 18:49:56
 *
...
#define S_FUNCTION_NAME  SFunctionGTDriverDataRecorderBus
...
#define SAMPLE_TIME (ssGetSFcnParam(S, 10))
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    /* Check the parameter 11 (sample time) */
    if (EDIT_OK(S, 10)) {
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T u2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 3));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GT_DriverDataRecorderBusInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverDataRecorderBusStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverDataRecorderBusTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverDataRecorderBusInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverDataRecorderBusStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverDataRecorderBusTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverDataRecorderBusInitialize(p1, *p2, *p3, *p4, p5, *p6, p7, *p8, p9, *p10);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverDataRecorderBusStep(p1, *p2, *u1, u2, *p4);
}
