 ...
 *    C++ source code generated on : 20-May-2024 01:40:20
 *
...
#define SAMPLE_TIME (ssGetSFcnParam(S, 12))
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    /* Check the parameter 13 (sample time) */
    if (EDIT_OK(S, 12)) {
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 10, 10, "p11", ssGetDataTypeId(S, "uint32"));

    /* Register the run-time parameter 12 */
    ssRegDlgParamAsRunTimeParam(S, 11, 11, "p12", ssGetDataTypeId(S, "uint8"));
}
#endif
...
static void mdlStart(SimStruct *S)
{
    ...
    uint32_T* p11 = (uint32_T*) ssGetRunTimeParamInfo(S, 10)->data;
    uint8_T* p12 = (uint8_T*) ssGetRunTimeParamInfo(S, 11)->data;


    /* Call the legacy code function */
    GT_DriverUDPUnicastReceiveInitialize(*p1, p2, *p3, *p4, *p5, *p6, p7, *p8, *p9, p10, *p11, *p12);
}
#endif
