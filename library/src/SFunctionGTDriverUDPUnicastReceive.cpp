 ...
 *
 *         void GT_DriverUDPUnicastReceiveStep(uint16 p1, uint32 p3, uint32 p6, uint16 y1[5*p6], uint8 y2[p3*p6], uint32 y3[p6], double y4[p6], uint32 y5[1], uint32 y6[1], int32 y7[1])
 *
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    if (EDIT_OK(S, 7)) {
        ...
        /* Parameter 8 must have 4 elements */
        if (((int_T)mxGetNumberOfElements(ssGetSFcnParam(S, 7))) != 4) {
            ssSetErrorStatus(S,"Parameter 8 must have 4 elements");
            return;
        } /* if */
    ...
    /* Check the parameter 10 (sample time) */
    if (EDIT_OK(S, 9)) {
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y1Width = 5*(int_T)mxGetScalar(ssGetSFcnParam(S, 5));
    ...
    {
        int_T y2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 2))*(int_T)mxGetScalar(ssGetSFcnParam(S, 5));
    ...
    {
        int_T y3Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 5));
    ...
    {
        int_T y4Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 5));
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 6, 6, "p7", ssGetDataTypeId(S, "uint32"));
...
static void mdlStart(SimStruct *S)
{
    ...
    uint32_T* p7 = (uint32_T*) ssGetRunTimeParamInfo(S, 6)->data;
    uint8_T* p8 = (uint8_T*) ssGetRunTimeParamInfo(S, 7)->data;
    uint8_T* p9 = (uint8_T*) ssGetRunTimeParamInfo(S, 8)->data;


    /* Call the legacy code function */
    GT_DriverUDPUnicastReceiveInitialize(*p1, p2, *p3, *p4, *p5, *p6, *p7, p8, *p9);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverUDPUnicastReceiveStep(*p1, *p3, *p6, y1, y2, y3, y4, y5, y6, y7);
}
