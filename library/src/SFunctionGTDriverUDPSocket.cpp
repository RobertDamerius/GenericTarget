 ...
 *
 *         void GT_DriverUDPSocketStep(int32 p1, uint8 p10, int32 p11, uint8 y1[p11], uint32 y2[1], uint8 y3[4], uint16 y4[1], int32 y5[1], int32 y6[1], uint8 u1[4], uint16 u2, uint8 u3[], uint32 u4, uint8 u5[], uint32 u6)
 *
 *    Simulink version           : 24.1 (R2024a) 19-Nov-2023
 *    C++ source code generated on : 16-Nov-2024 18:14:54
 *
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    if (EDIT_OK(S, 10)) {
        ...
        /* Parameter 11 must be numeric */
        if (!mxIsNumeric(ssGetSFcnParam(S, 10))) {
            ssSetErrorStatus(S,"Parameter 11 must be numeric");
            return;
        } /* if */
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y1Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 10));
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverUDPSocketInitialize(*p1, p2, *p3, *p4, *p5, *p6, *p7, *p8, *p9);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverUDPSocketStep(*p1, *p10, *p11, y1, y2, y3, y4, y5, y6, u1, *u2, u3, *u4, u5, *u6);
}
