/**
 * SFunctionGTDriverUDPSocket.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GT_DriverUDPSocketStep(int32 p1, uint8 p11, int32 p12, uint8 y1[p12], uint32 y2[1], uint8 y3[4], uint16 y4[1], int32 y5[1], int32 y6[1], uint8 u1[4], uint16 u2, uint8 u3[], uint32 u4, uint8 u5[], uint32 u6)
 *
 *    Simulink version           : 24.1 (R2024a) 19-Nov-2023
 *    C++ source code generated on : 22-Feb-2025 11:15:36
 *
...
#define S_FUNCTION_NAME  SFunctionGTDriverUDPSocket
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    if (EDIT_OK(S, 11)) {
        ...
        /* Parameter 12 must be numeric */
        if (!mxIsNumeric(ssGetSFcnParam(S, 11))) {
            ssSetErrorStatus(S,"Parameter 12 must be numeric");
            return;
        } /* if */
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T u3Width = DYNAMICALLY_SIZED;
    ...
    {
        int_T u5Width = DYNAMICALLY_SIZED;
    ...
    {
        int_T y1Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 11));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GT_DriverUDPSocketInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverUDPSocketStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverUDPSocketTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverUDPSocketInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverUDPSocketStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverUDPSocketTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverUDPSocketInitialize(*p1, p2, *p3, *p4, *p5, *p6, *p7, *p8, *p9, p10);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint32_T* u6 = (uint32_T*) ssGetInputPortSignal(S, 5);


    /* Call the legacy code function */
    GT_DriverUDPSocketStep(*p1, *p11, *p12, y1, y2, y3, y4, y5, y6, u1, *u2, u3, *u4, u5, *u6);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    GT_DriverUDPSocketTerminate(*p1);
}
