 ...
 *
 *         void GT_DriverUDPMulticastReceiveStep(uint16 p1, uint32 p7, uint32 p9, uint16 y1[5*p9], uint8 y2[p7*p9], uint32 y3[p9], double y4[p9], uint32 y5[1], uint32 y6[1], int32 y7[1])
 *
...
static void mdlCheckParameters(SimStruct *S)
{
    ...
    if (EDIT_OK(S, 3)) {
        ...
        /* Parameter 4 must have 4 elements */
        if (((int_T)mxGetNumberOfElements(ssGetSFcnParam(S, 3))) != 4) {
            ssSetErrorStatus(S,"Parameter 4 must have 4 elements");
            return;
        } /* if */
    ...
    if (EDIT_OK(S, 6)) {
        ...
        /* Parameter 7 must be numeric */
        if (!mxIsNumeric(ssGetSFcnParam(S, 6))) {
            ssSetErrorStatus(S,"Parameter 7 must be numeric");
            return;
        } /* if */
    ...
    if (EDIT_OK(S, 8)) {
        ...
        /* Parameter 9 must be numeric */
        if (!mxIsNumeric(ssGetSFcnParam(S, 8))) {
            ssSetErrorStatus(S,"Parameter 9 must be numeric");
            return;
        } /* if */
    ...
    if (EDIT_OK(S, 10)) {
        ...
        /* Parameter 11 must have 4 elements */
        if (((int_T)mxGetNumberOfElements(ssGetSFcnParam(S, 10))) != 4) {
            ssSetErrorStatus(S,"Parameter 11 must have 4 elements");
            return;
        } /* if */
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y1Width = 5*(int_T)mxGetScalar(ssGetSFcnParam(S, 8));
    ...
    {
        int_T y2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 6))*(int_T)mxGetScalar(ssGetSFcnParam(S, 8));
    ...
    {
        int_T y3Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 8));
    ...
    {
        int_T y4Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 8));
...
static void mdlSetWorkWidths(SimStruct *S)
{
    ...
    ssRegDlgParamAsRunTimeParam(S, 12, 12, "p13", ssGetDataTypeId(S, "uint8"));
}
#endif
...
static void mdlStart(SimStruct *S)
{
    ...
    uint8_T* p13 = (uint8_T*) ssGetRunTimeParamInfo(S, 12)->data;


    /* Call the legacy code function */
    GT_DriverUDPMulticastReceiveInitialize(*p1, p2, *p3, p4, p5, *p6, *p7, *p8, *p9, *p10, p11, *p12, *p13);
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverUDPMulticastReceiveStep(*p1, *p7, *p9, y1, y2, y3, y4, y5, y6, y7);
}
