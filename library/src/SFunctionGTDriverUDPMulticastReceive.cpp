 ...
 *
 *         void GT_DriverUDPMulticastReceiveStep(uint16 p1, uint32 p6, uint32 p8, uint16 y1[5*p8], uint8 y2[p6*p8], uint32 y3[p8], double y4[p8], uint32 y5[1], uint32 y6[1], int32 y7[1])
 *
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y2Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 5))*(int_T)mxGetScalar(ssGetSFcnParam(S, 7));
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    GT_DriverUDPMulticastReceiveStep(*p1, *p6, *p8, y1, y2, y3, y4, y5, y6, y7);
}
