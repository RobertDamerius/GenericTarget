/**
 * SFunctionGTDriverNumCPUOverloads.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void GT_DriverNumCPUOverloadsStep(uint64 y1[1], uint64 y2[1])
 *
...
#define S_FUNCTION_NAME  SFunctionGTDriverNumCPUOverloads
...
{
    /* Required for registering int64/uint64 */
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "GT_DriverNumCPUOverloadsInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverNumCPUOverloadsStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "GT_DriverNumCPUOverloadsTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverNumCPUOverloadsInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverNumCPUOverloadsStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "GT_DriverNumCPUOverloadsTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    GT_DriverNumCPUOverloadsInitialize();
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint64_T* y2 = (uint64_T*) ssGetOutputPortSignal(S, 1);


    /* Call the legacy code function */
    GT_DriverNumCPUOverloadsStep(y1, y2);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    GT_DriverNumCPUOverloadsTerminate();
}
